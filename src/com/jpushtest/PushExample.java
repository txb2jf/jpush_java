...
public class PushExample {
    ...
    public static void testSendPushWithCallback() {
        ...
        final NettyHttpClient client = new NettyHttpClient(ServiceHelper.getBasicAuthorization(
                APP_KEY, MASTER_SECRET), null, clientConfig);
        try {
    ...
    public static void testSendPushesWithMultiCallback() {
        NettyHttpClient client = new NettyHttpClient(ServiceHelper.getBasicAuthorization(APP_KEY,
                MASTER_SECRET), null, ClientConfig.getInstance());
        ...
        public void run() {
            ...
            try {
                ...
                URI uri = new URI(host
                        + (String) ClientConfig.getInstance().get(ClientConfig.PUSH_PATH));
                PushPayload payload = PushPayload.alertAll("test");
                System.out.println(payload.toString());
                // client.sendRequest(HttpMethod.POST, payload.toString(), uri,
                // callback);
    ...
    public static void testSendPush_fromJSON() {
        ...
        Gson gson = new GsonBuilder().registerTypeAdapter(PlatformNotification.class,
    ...
    public static PushPayload buildPushObject_all_alias_alert() {
        return PushPayload.newBuilder().setPlatform(Platform.all())
                .setAudience(Audience.alias("0123456789")).setNotification(Notification.alert(ALERT))
                .build();
    }
                ...
                .setNotification(
                        Notification
                                ...
                                .addPlatformNotification(
                                        AndroidNotification.newBuilder().setTitle("Android Title")
                                                .build())
                                .addPlatformNotification(
        ...
        PushPayload payload = PushPayload
                ...
                .setNotification(
                        Notification
                                ...
                                .addPlatformNotification(
                                        AndroidNotification.newBuilder().setTitle("Android Title")
                                                .addExtras(extras).addExtra("booleanExtra", false)
                        ...
                        Notification
                                ...
                                .addPlatformNotification(
                                        IosNotification.newBuilder().setAlert(ALERT).setBadge(5)
                                                .setSound("happy").addExtra("from", "JPush")
                                                .build()).build())
        ...
        Notification notification = Notification
                ...
                .addPlatformNotification(
                        AndroidNotification.newBuilder().setAlert(ALERT)
                                .setBigPicPath("path to big picture").setBigText("long text")
                                .setBuilderId(1).setCategory("CATEGORY_SOCIAL").setInbox(inbox)
                                .setStyle(1).setTitle("Alert test").setPriority(1).build()).build();
        return PushPayload.newBuilder().setPlatform(Platform.all())
                .setAudience(Audience.registrationId("18071adc030dcba91c0"))
                .setNotification(notification).setOptions(Options.sendno()).build();
    }
        ...
        return PushPayload
                ...
                .setAudience(
                        Audience.newBuilder().addAudienceTarget(AudienceTarget.tag("tag1", "tag2"))
                                ...
                                .build())
                .setMessage(
                        Message.newBuilder().setMsgContent(MSG_CONTENT).addExtra("from", "JPush")
                                .build()).build();
    }
    ...
    public static void testSendWithSMS() {
        ...
        try {
            ...
            PushResult result = jpushClient.sendAndroidMessageWithAlias("Test SMS", "test sms",
                    sms, "alias1");
            LOG.info("Got result - " + result);
        } catch (APIConnectionException e) {
            LOG.error("Connection error. Should retry later. ", e);
