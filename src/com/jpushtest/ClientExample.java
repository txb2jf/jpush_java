...
public class ClientExample {
    ...
    public static void testDefaultClient() {
        ...
        // JPushClient client1 = new JPushClient(masterSecret, appKey, null,
    ...
    public static void testCustomPushClient() {
        ...
        JPushClient jPushClient = new JPushClient(masterSecret, appKey, null, config); // JPush
                                                                                       // client

        // PushClient pushClient = new PushClient(masterSecret, appKey, null,
        // config); // push client only
